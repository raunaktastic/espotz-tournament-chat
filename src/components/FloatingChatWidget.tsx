    ...
    <>
      ...
      {!isOpen && (
        ...
        <button
          ...
          className="hidden md:flex fixed bottom-20 right-4 z-50 h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-purple-600 to-indigo-600 text-white shadow-xl shadow-purple-900/50 transition-transform hover:scale-105 active:scale-95 cursor-pointer md:bottom-6 md:right-6"
